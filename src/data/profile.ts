  ...
  ar: {
    meta: {
      ...
      roles: [
        ...
        'مهندس مرخص من الهيئة السعودية للمهندسين',
        'مدير تطوير أعمال في يونيك مارك للتسويق',
        'رائد أعمال',
        'مؤسس متجر أبو ميس للحلول المتكاملة',
        'مؤسس بودكاست سَفر',
        'مؤسس وكالة مِعيار للحلول التسويقية',
      ],
      location: 'الرياض، المملكة العربية السعودية',
    },
    hero: {
      kicker: 'نسيم فلفلان',
      tagline: 'عقل مهــــــــــني. نفس تجـــــاري. ولسان يعرف من أين تُؤكل الفـرص.',
    ...
    stats: {
      ...
      items: [
        ...
        { value: '✓', label: 'أسس وأدار متجرًا إلكترونيًا عبر منصة سلة' },
        { value: '✓', label: 'عمل في تطوير الأعمال واستقطاب العملاء كمدير لتطوير الأعمال لدى يونيك مارك للتسويق' },
        { value: '✓', label: 'أعد تقارير تحليلية وعروضًا تنفيذية لدعم القرار' },
      ],
